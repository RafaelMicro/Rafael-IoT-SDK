...
#define HA_THERMOSTAT_DEVICE_ID 0x0301
//=============================================================================
...
ZB_AF_SIMPLE_DESC_TYPE(4, 0)
simple_desc_thermostat = {
    THERMOSTAT_EP,   /* Endpoint */
    ...
    0,                              /* Reserved */
    4,                              /* Application input cluster count */
...
ZB_AF_DECLARE_ENDPOINT_DESC(
    thermostat_ep, THERMOSTAT_EP, ZB_AF_HA_PROFILE_ID, 0, NULL,
    ZB_ZCL_ARRAY_SIZE(g_zigbee_cluster_list, zb_zcl_cluster_desc_t),
    g_zigbee_cluster_list, (zb_af_simple_desc_1_1_t*)&simple_desc_thermostat, 8,
    rep_ctx, 0, NULL);

ZB_AF_DECLARE_ENDPOINT_DESC(thermostat_ota_ep, 10, ZB_AF_HA_PROFILE_ID, 0, NULL,
                            ZB_ZCL_ARRAY_SIZE(g_zigbee_cluster_ota_list,
                                              zb_zcl_cluster_desc_t),
                            g_zigbee_cluster_ota_list,
                            (zb_af_simple_desc_1_1_t*)&simple_desc_thermostat_ota, 0,
                            NULL, 0, NULL);

// zb_af_endpoint_desc_t* thermostat_ep_list[] = {&thermostat_ep, &thermostat_ota_ep};

// zb_af_device_ctx_t simple_desc_thermostat_ctx = {2, thermostat_ep_list};

ZBOSS_DECLARE_DEVICE_CTX_2_EP(simple_desc_thermostat_ctx, thermostat_ep, thermostat_ota_ep);
