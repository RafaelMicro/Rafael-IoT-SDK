...
#define HA_PIR_SENSOR_DEVICE_ID 0x0402 //act as the ias zone device ID(HA_IAS_ZONE_ID)
//=============================================================================
...
ZB_AF_SIMPLE_DESC_TYPE(5, 0) simple_desc_pir_sensor_ep =
{
    PIR_SENSOR_EP,                                  /* Endpoint */
    ZB_AF_HA_PROFILE_ID,                           /* Application profile identifier */
    HA_PIR_SENSOR_DEVICE_ID,              /* Application device identifier */
...
ZB_AF_SIMPLE_DESC_TYPE(0, 1) simple_desc_pir_sensor_ota =
{
    10,                                              /* Endpoint */
    ZB_AF_HA_PROFILE_ID,                            /* Application profile identifier */
    HA_PIR_SENSOR_DEVICE_ID,              /* Application device identifier */
...
ZB_AF_DECLARE_ENDPOINT_DESC(
    ...
    (zb_af_simple_desc_1_1_t *)&simple_desc_pir_sensor_ep,
    8,
    rep_ctx,
    0,
    NULL);
...
ZB_AF_DECLARE_ENDPOINT_DESC(
    ...
    (zb_af_simple_desc_1_1_t *)&simple_desc_pir_sensor_ota,
    0,
    NULL,
    0,
    NULL);

zb_af_endpoint_desc_t *ep_list_pir_sensor[] =
{
    &pir_sensor_ep,
    &pir_sensor_ota_ep
};

//zb_af_device_ctx_t simple_desc_pir_sensor_ctx =
//{
//    2,
//    ep_list_pir_sensor
//}

ZBOSS_DECLARE_DEVICE_CTX_2_EP(simple_desc_pir_sensor_ctx, pir_sensor_ep, pir_sensor_ota_ep);
