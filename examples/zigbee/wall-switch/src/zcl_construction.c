...
#define HA_ON_OFF_LIGHT_SWITCH_DEVICE_ID 0x0103
//=============================================================================
...
ZB_AF_SIMPLE_DESC_TYPE(0, 1) simple_desc_wall_switch_ota =
{
    10,                                              /* Endpoint */
    ZB_AF_HA_PROFILE_ID,                            /* Application profile identifier */
    HA_ON_OFF_LIGHT_SWITCH_DEVICE_ID,              /* Application device identifier */
...
ZB_AF_DECLARE_ENDPOINT_DESC(
    ...
    (zb_af_simple_desc_1_1_t *)&simple_desc_wall_switch_ep,
    8,
    rep_ctx,
    1,
    NULL);
...
ZB_AF_DECLARE_ENDPOINT_DESC(
    ...
    (zb_af_simple_desc_1_1_t *)&simple_desc_wall_switch_ota,
    0,
    NULL,
    0,
    NULL);

zb_af_endpoint_desc_t *ep_list_wall_switch[] =
{
    &wall_switch_ep,
    &wall_switch_ota_ep
};

//zb_af_device_ctx_t simple_desc_wall_switch_ctx =
//{
//    2,
//    ep_list_wall_switch
//}

ZBOSS_DECLARE_DEVICE_CTX_2_EP(simple_desc_wall_switch_ctx, wall_switch_ep, wall_switch_ota_ep);
