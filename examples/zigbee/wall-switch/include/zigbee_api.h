...
typedef enum {
    ...
    ZB_APP_EVENT_TOGGLE = 0x00000010,
    ZB_APP_EVENT_LEVEL_UP = 0x00000020,
    ZB_APP_EVENT_LEVEL_DOWN = 0x00000040,
...
extern zb_af_device_ctx_t simple_desc_wall_switch_ctx;
