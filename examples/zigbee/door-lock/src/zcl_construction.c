...
#define HA_DOOR_LOCK_DEVICE_ID 0x000A
//=============================================================================
...
uint8_t g_att_lock_state = ZB_ZCL_ATTR_DOOR_LOCK_LOCK_STATE_LOCKED;
uint8_t g_att_lock_type = 0;
zb_bool_t g_att_actuator_enabled = 0;
uint8_t g_att_pin_code[17] = {8, '1', '2', '3', '4', '5', '6', '7', '8'};
...
ZB_AF_SIMPLE_DESC_TYPE(6, 0) simple_desc_door_lock_ep =
{
    DOOR_LOCK_EP,                                  /* Endpoint */
...
ZB_AF_SIMPLE_DESC_TYPE(0, 1) simple_desc_door_lock_ota =
{
    10,                                              /* Endpoint */
    ZB_AF_HA_PROFILE_ID,                            /* Application profile identifier */
    HA_DOOR_LOCK_DEVICE_ID,              /* Application device identifier */
...
ZB_AF_DECLARE_ENDPOINT_DESC(
    ...
    (zb_af_simple_desc_1_1_t *)&simple_desc_door_lock_ep,
    8,
    rep_ctx,
    0,
    NULL);
...
ZB_AF_DECLARE_ENDPOINT_DESC(
    ...
    (zb_af_simple_desc_1_1_t *)&simple_desc_door_lock_ota,
    0,
    NULL,
    0,
    NULL);

zb_af_endpoint_desc_t *ep_list_door_lock[] =
{
    &door_lock_ep,
    &door_lock_ota_ep
};

//zb_af_device_ctx_t simple_desc_door_lock_ctx =
//{
//    2,
//    ep_list_door_lock
//}

ZBOSS_DECLARE_DEVICE_CTX_2_EP(simple_desc_door_lock_ctx, door_lock_ep, door_lock_ota_ep);
