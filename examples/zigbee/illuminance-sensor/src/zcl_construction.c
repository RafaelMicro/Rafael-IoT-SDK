...
#define HA_ILLUMINANCE_SENSOR_DEVICE_ID 0x0106 //act as the light sensor device ID(HA_LIGHT_SENSOR_DEVICE_ID)
//=============================================================================
...
uint16_t g_attr_illuminance_min_value = 0x0001;
uint16_t g_attr_illuminance_max_value = 0xFFFE;
...
ZB_ZCL_DECLARE_POWER_CONFIG_BATTERY_ATTRIB_LIST_EXT_1(power_config_attr_list,
...
ZB_AF_SIMPLE_DESC_TYPE(5, 0) simple_desc_illuminance_sensor_ep =
{
    ILLUMINANCE_SENSOR_EP,                                  /* Endpoint */
    ZB_AF_HA_PROFILE_ID,                           /* Application profile identifier */
    HA_ILLUMINANCE_SENSOR_DEVICE_ID,              /* Application device identifier */
...
ZB_AF_SIMPLE_DESC_TYPE(0, 1) simple_desc_illuminance_sensor_ota =
{
    10,                                              /* Endpoint */
    ZB_AF_HA_PROFILE_ID,                            /* Application profile identifier */
    HA_ILLUMINANCE_SENSOR_DEVICE_ID,              /* Application device identifier */
...
ZB_AF_DECLARE_ENDPOINT_DESC(
    ...
    (zb_af_simple_desc_1_1_t *)&simple_desc_illuminance_sensor_ep,
    8,
    rep_ctx,
    0,
    NULL);
...
ZB_AF_DECLARE_ENDPOINT_DESC(
    ...
    (zb_af_simple_desc_1_1_t *)&simple_desc_illuminance_sensor_ota,
    0,
    NULL,
    0,
    NULL);

zb_af_endpoint_desc_t *ep_list_illuminance_sensor[] =
{
    &illuminance_sensor_ep,
    &illuminance_sensor_ota_ep
};

//zb_af_device_ctx_t simple_desc_illuminance_sensor_ctx =
//{
//    2,
//    ep_list_illuminance_sensor
//}

ZBOSS_DECLARE_DEVICE_CTX_2_EP(simple_desc_illuminance_sensor_ctx, illuminance_sensor_ep, illuminance_sensor_ota_ep);
