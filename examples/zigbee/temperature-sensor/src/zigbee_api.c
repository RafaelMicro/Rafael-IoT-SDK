...
int16_t simulated_measured_value[5] = {2800, 3200, 1650, 2480, 2560};
...
static void sensor_timer_handler(TimerHandle_t timer) {
    ...
    log_info("new temperature value %d", simulated_measured_value[index]);
...
void zigbee_app_set_measured_value(int16_t value) {
    int16_t new_value = value;
    zigbee_zcl_set_attrubute(TEMPERATURE_SENSOR_EP, ZB_ZCL_CLUSTER_ID_TEMP_MEASUREMENT, ZB_ZCL_CLUSTER_SERVER_ROLE,
                            ZB_ZCL_ATTR_TEMP_MEASUREMENT_VALUE_ID, (uint8_t*) &new_value);
}
