...
#define HA_TEMPERATURE_SENSOR_DEVICE_ID 0x0302 //act as the ias zone device ID(HA_IAS_ZONE_ID)
//=============================================================================
...
ZB_AF_SIMPLE_DESC_TYPE(6, 0) simple_desc_temperature_sensor_ep =
{
    TEMPERATURE_SENSOR_EP,                                  /* Endpoint */
...
ZB_AF_SIMPLE_DESC_TYPE(0, 1) simple_desc_temperature_sensor_ota =
{
    10,                                              /* Endpoint */
    ZB_AF_HA_PROFILE_ID,                            /* Application profile identifier */
    HA_TEMPERATURE_SENSOR_DEVICE_ID,              /* Application device identifier */
...
ZB_AF_DECLARE_ENDPOINT_DESC(
    ...
    (zb_af_simple_desc_1_1_t *)&simple_desc_temperature_sensor_ep,
    8,
    rep_ctx,
    0,
    NULL);
...
ZB_AF_DECLARE_ENDPOINT_DESC(
    ...
    (zb_af_simple_desc_1_1_t *)&simple_desc_temperature_sensor_ota,
    0,
    NULL,
    0,
    NULL);

zb_af_endpoint_desc_t *ep_list_temperature_sensor[] =
{
    &temperature_sensor_ep,
    &temperature_sensor_ota_ep
};

//zb_af_device_ctx_t simple_desc_temperature_sensor_ctx =
//{
//    2,
//    ep_list_temperature_sensor
//}

ZBOSS_DECLARE_DEVICE_CTX_2_EP(simple_desc_temperature_sensor_ctx, temperature_sensor_ep, temperature_sensor_ota_ep);
