...
int main(void) {
    ...
    printf("Build Time:%s \r\n",__TIME__);
    printf("----------------------------------------------------------------\r\n");
    printf("Examples    : hosal QSPI access external spi flash demo\r\n");
    printf("[QSPI config]\r\n");
    printf(" Speed        : 32M\r\n"); 
    printf(" Data Bit     : 8\r\n"); 
    ...
    printf("[QSPI Pin]      CS Pin       : GPIO7 \r\n");
    printf("                CLK Pin      : GPIO6 \r\n\n");
    printf("                DATA0 Pin    : GPIO8 \r\n\n");
    printf("                DATA1 Pin    : GPIO9 \r\n\n");
    printf("                DATA2 Pin    : GPIO14 \r\n\n");
    printf("                DATA3 Pin    : GPIO15 \r\n\n");
    printf("QSPI CS connect spi flash cs\r\n");
    printf("QSPI CLK connect spi flash clock\r\n");
    printf("QSPI DATA0 connect spi flash miso\r\n");
    printf("QSPI DATA1 connect spi flash mosi\r\n");
    printf("QSPI DATA2 connect spi flash wp\r\n");
    printf("QSPI DATA3 connect spi flash hold\r\n");
    printf("----------------------------------------------------------------\r\n");
