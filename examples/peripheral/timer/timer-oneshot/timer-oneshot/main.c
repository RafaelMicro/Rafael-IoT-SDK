...
int main(void) {
    ...
    printf("/*****Start Timer OneShot*****/\r\n");
    printf("Timer 0 one shot enable, timer 1 is disable\r\n");
    printf("You can see when timer 0 timeout trigger\r\n");
    printf("you get the current value is timeout ticks, \r\n");
    printf("but timer1 can see timeout trigger, the current value\r\n");
    printf("keep count.\r\n");
