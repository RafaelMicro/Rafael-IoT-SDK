...
void timer_freerun_upcnt(void) {
    ...
    cfg0.user_prescale = 15;

    tick_cfg0.timeload_ticks = 0;
    tick_cfg0.timeout_ticks = 10000000;

    /* This setting is 50s timeout */
    ...
    cfg1.user_prescale = 159;

    tick_cfg1.timeload_ticks = 0;
    tick_cfg1.timeout_ticks = 10000000;
    ...
    cfg2.prescale = HOSAL_TIMER_PRESCALE_16;
    cfg2.user_prescale = 31;

    tick_cfg2.timeload_ticks = 0;
    tick_cfg2.timeout_ticks = 10000000;
...
int main(void) {
    ...
    printf("/*****Start Timer User Prescale*****/\r\n");
    printf("\r\n");
