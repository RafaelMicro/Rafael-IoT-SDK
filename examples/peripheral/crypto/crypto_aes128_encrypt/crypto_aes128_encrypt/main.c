...
int main(void) {
    ...
    printf("Build Time:%s \r\n",__TIME__);
    printf("----------------------------------------------------------------\r\n");
    printf("Examples    : crypto aes 128 encrypt demo\r\n");
    printf("----------------------------------------------------------------\r\n");
    ...
    for(i =0 ;i<64;i+=HOSAL_AES_BLOCKLEN)
    {
        ...
        aes_dev.in_ptr =  (plaintext_data+i);
        aes_dev.out_ptr = (g_encryption_text_buf+i);
        aes_dev.key_ptr = key;
    ...
    {
        printf(" AES_128_test hardware encryption ECB: SUCCESS!\r\n");      /*encryption correct */
    }
    else
    {
        printf(" AES_128_test hardware encryption ECB: failure!\r\n");
    }

    
    printf("\r\n\r\n");
    printf("hosal crypto aes 128 encryption finish!\r\n");
    while (1);
}
