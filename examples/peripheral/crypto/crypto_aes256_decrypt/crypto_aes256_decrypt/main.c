...
int main(void) {
    ...
    printf("Build Time:%s \r\n",__TIME__);
    printf("----------------------------------------------------------------\r\n");
    printf("Examples    : hosal crypto aes 256 decrypt demo\r\n");
    printf("----------------------------------------------------------------\r\n");
	...
	aes_dev.in_ptr =  cryption_buf;
	aes_dev.out_ptr = hw_decryptio_cleartext_buf;
	aes_dev.key_ptr = key;
    ...
    {
        printf("AES_256_test hardware decryption  ECB: SUCCESS!\r\n");
    }
    else
    {
        printf("AES_256_test hardware decryption  ECB: FAILURE!\r\n");
    }
