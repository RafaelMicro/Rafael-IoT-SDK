...
int main(void) {
    ...
    while (1) {
        ...
        irm_cmd = tmp_cmd;
        irm_address = tmp_address;

        hosal_ir_carrier_config(HOSAL_SIRC_CARRIER_HIGH_CNT, HOSAL_SIRC_CARRIER_LOW_CNT, HOSAL_SIRC_CARRIER_BASEMENT_CNT);
        //hosal_ir_sirc_encoder( irm_cmd, irm_address, HOSAL_SIRC_12bits);
        hosal_ir_sirc_encoder( irm_cmd, irm_address, HOSAL_SIRC_15bits);
