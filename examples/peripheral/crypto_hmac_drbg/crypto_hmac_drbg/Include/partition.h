...
__STATIC_INLINE void TZ_SAU_Setup (void)
{
    ...
    flash_model_info =  inp32((((void *)FLASH) + 0x38));
    ...
    SEC_CTRL->SEC_FLASH_SEC_SIZE = 0x800;         /* 0x10010000 (0x10000000 + (sec_flash_s_stop*32)-1)--> 0x800*32 --> 10000 (64K)-1=0xFFFF  0x30000000~0x3000FFFF*/
    SEC_CTRL->SEC_FLASH_NSC_START = 0x7C0;        /* 0x1000F7FF (0x10000000 + (sec_flash_nsc_start*32)-1--> 0x7C0*32 --> F800-1=F7FF*/
    SEC_CTRL->SEC_FLASH_NSC_STOP = 0x7E0;         /* 0x1000FBFF (0x10000000 + (sec_flash_nsc_stop*32)-1--> 0x7E0*32 --> FC00-1=FBFF*/
     ...
     */
    SEC_CTRL->SEC_RAM_SEC_SIZE = 0x800;       /* 0x30010000 (0x30000000 + sec_ram_s_stop*32-1)--> 0x800*32 --> 10000 (64K)  0x30000000~0x3000FFFF*/
    SEC_CTRL->SEC_RAM_NSC_START = 0x800;      /* 0x3000F7FF (0x30000000 + sec_ram_nsc_start*32-1) 0x7C0*32 --> F7FF*/
    SEC_CTRL->SEC_RAM_NSC_STOP = 0x800;       /* 0x3000FBFF (0x30000000 + sec_ram_nsc_start*32-1) 0x7E0*32 --> FBFF*/
    //SEC_CTRL->SEC_RAM_NS_STOP = 0xFFF;      /* (0x00000000+sec_ram_s_stop*32) to (0x00000000+sec_ram_ns_stop*32 -1). )*/
