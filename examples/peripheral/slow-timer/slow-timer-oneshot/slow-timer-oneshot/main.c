...
int main(void) {
    ...
    puts("/*****Start Slow Timer One Shot*****/ \r\n");
    puts("Slow timer 0 one shot enable, slow timer 1 is disable\r\n");
    puts("You can see when slow timer 0 timeout trigger\r\n");
