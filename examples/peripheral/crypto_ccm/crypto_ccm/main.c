...
void ccm_test_vector_1(void) {
    ...
    if (status != STATUS_SUCCESS) {
        printf("Please Check input ccm config setting. \r\n");
    } else {
        /* check result*/
        ...
        if ((outbuf_length != EXPECTED_BUF_LEN39) ||
            ...
            printf("ccm_encryption produced wrong data !! \r\n");
        } else {
            printf("ccm_encryption test vector #1 correct ! \r\n");
        }
    ...
    if (status == STATUS_SUCCESS) {
        ...
        if ((outbuf_length != DATA_BUF_LEN23) ||
            ...
            printf("ccm_decryption for test vector #1 error ?1 \r\n");
        } else {
            printf("ccm_decryption and verification for test vector #1 correct ! \r\n");
        }

    } else {
        printf("ccm_dncryption wrong ?! \r\n");
    }
...
void ccm_test_vector_2(void) {
    ...
    if (status != STATUS_SUCCESS) {
        ...
        if ((outbuf_length != sizeof(expected)) ||
            ...
            printf("ccm_encryption test vector #2 correct ! \r\n");
        }
