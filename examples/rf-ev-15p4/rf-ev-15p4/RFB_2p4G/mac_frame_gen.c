...
void Rfb_MacFrameGen(MacBuffer_t *pbuf, uint8_t *tx_control, uint8_t Dsn, uint8_t MacDataLength)
{
    uint8_t idx;
    uint8_t payloadLength = MacDataLength;
    uint8_t initialCW;
    uint8_t ackRequest;
    uint8_t max_data_size = OQPSK_MAX_DATA_SIZE;
