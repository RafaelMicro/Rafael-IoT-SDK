...
typedef enum
{
    ENERGY_DETECTION                       = 0,
    CARRIER_SENSING                       = 1,
    ENERGY_DETECTION_AND_CARRIER_SENSING  = 2,
    ENERGY_DETECTION_OR_CARRIER_SENSING   = 3
} cca_mode_t;
...
void Rfb_MacFrameGen(MacBuffer_t *pbuf, uint8_t *InitialCwAckRequest, uint8_t Dsn, uint8_t MacDataLength);
#endif
