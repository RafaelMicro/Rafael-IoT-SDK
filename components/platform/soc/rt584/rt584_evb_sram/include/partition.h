...
__STATIC_INLINE void TZ_SAU_Setup (void)
{
     ...
     */
    SEC_CTRL->SEC_RAM_SEC_SIZE =  0x1800;      /* 0x30010000 (0x30000000 + sec_ram_s_stop*32-1)--> 0x800*32 --> 10000 (64K)  0x30000000~0x3000FFFF*/
    SEC_CTRL->SEC_RAM_NSC_START =  0x1800;      /* 0x3000F7FF (0x30000000 + sec_ram_nsc_start*32-1) 0x7C0*32 --> F7FF*/
    SEC_CTRL->SEC_RAM_NSC_STOP =  0x1800;       /* 0x3000FBFF (0x30000000 + sec_ram_nsc_start*32-1) 0x7E0*32 --> FBFF*/
