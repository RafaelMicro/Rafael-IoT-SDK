 ...
 **********************************************************************************************************************/
/**
* @brief config qspi paramas
* @param[in] qspi_id  spi identifie
* @param[in] qspi_transfer_mode_t  spi mode, master or slave, mode
*/
...
* @param[in] qspi_id  spi identifie
* @param[in] SPI_CLK  spi clock source
*/
...
#if (MODULE_ENABLE(SUPPORT_QSPI0_MULTI_CS))
/**
* @brief  qspi0 set device polarity
* @param[in] slave_id  spi identifie
* @param[in] slave_polarity  spi slave polarity
*/
...
* @brief  Qspi transfer
* @param[in] slave_id  spi identifie
* @param[in] req  spi transfer length and buffer point
*/
                          ...
                          const spi_block_request_t *req)
{
    ...
    {
#if (EPD_FOUR_BIT_MODE==1) ||  (EPD_THREE_BIT_MODE==1)  //for support e-paper spi operation
        aux_reg = QSPI_BITSIZE_16 | QSPI_NORMAL_SPI | QSPI_Xfer_Extend;
#else
...
/**
* @brief Qspi write data into dma (DMA architecture)
* @param[in] qspi_id spi identifie
* @param[in] req  spi transfer length and buffer point
* @param[in] finish_proc_cb  dma callback function
*/
 ...
 */
/**
* @brief Qspi read data form dma (DMA architecture)
* @param[in] qspi_id spi identifie
* @param[in] req  spi transfer length and buffer point
* @param[in] finish_proc_cb  dma callback function
*/
...
/**
* @brief spi transfer slave aboort function
* @param[in] qspi_id
* @return None
*/
