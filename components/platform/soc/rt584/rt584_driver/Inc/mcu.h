...
#define SW_INT0               ((SWI_T *) (SW_IRQ0_BASE | PERIPH_SECURE_OFFSET))
#else
#define SW_INT0               ((SWI_T *) SW_IRQ0_BASE)
#endif

#if (SW_IRQ1_SECURE_EN == 1)
#define SW_INT1               ((SWI_T *) (SW_IRQ1_BASE | PERIPH_SECURE_OFFSET))
#else
#define SW_INT1               ((SWI_T *) SW_IRQ1_BASE)
#endif
