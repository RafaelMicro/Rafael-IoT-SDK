...
/*2024/04/15 this is shuttle version QSPI... it will be removed in MPA.*/
...
typedef struct
{
    ...
    __IO  EPD_FUNC_t QSPI_EPD_FUNC;          /*offset : 0x40*/
    __IO  uint32_t   QSPI_SS_MAN;            /*offset : 0x44*/
    __IO  uint32_t   reserved[2];            //0x40~0x4C
