 ...
 * @file     flashctrl.h
 * @version
 * @brief    rt584 flash control driver API
 *
 * @copyright
 **********************************************************************************************************************/
/**
* @defgroup flashctrl_group flashctrl
* @ingroup peripheral_group
* @{
* @brief   flash control definitions, structures, and functions
*/
...
#define BOOT_LOADER_END_PROTECT_ADDR        0x7000  /*!< Bootlader protect address  */
...
#define  RT582_2M_FLASH_TYPE       0x1565C8         /*!< GD SPI Flash identifier id  */
