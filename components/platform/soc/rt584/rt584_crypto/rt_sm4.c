...
void sm4_fw_init(void)
{
    ...
    crypto_copy((uint32_t *) (CRYPTO_BASE + 0x1028), (uint32_t *) sm4_genrk_bin, sizeof(sm4_genrk_bin));

    crypto_copy((uint32_t *) (CRYPTO_BASE + 0x10A0), (uint32_t *) sm4_engine_bin, sizeof(sm4_engine_bin));

    crypto_copy((uint32_t *) (CRYPTO_BASE + 0x1118), (uint32_t *) sm4_ecb_enc_bin, sizeof(sm4_ecb_enc_bin));

    crypto_copy((uint32_t *) (CRYPTO_BASE + 0x1140), (uint32_t *) sm4_ecb_dec_bin, sizeof(sm4_ecb_dec_bin));
...
void sm4_ecb_encode(uint8_t *out_packet, uint8_t *in_packet, uint8_t *mkey)
{
    ...
    *((volatile uint32_t *) (CRYPTO_BASE + 0x1000)) = (0xa0000000 | SM4_ECB_Enc_inst_index);
...
void sm4_ecb_decode(uint8_t *out_packet, uint8_t *in_packet, uint8_t  *mkey)
{
    ...
    *((volatile uint32_t *) (CRYPTO_BASE + 0x1000)) = (0xa0000000 | SM4_ECB_Dec_inst_index);
