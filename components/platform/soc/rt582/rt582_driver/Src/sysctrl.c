 ...
 *    GLOBAL VARIABLES
 *************************************************************************************************/
delay_us_fn Delay_us = Delay_us_64MHz;
delay_ms_fn Delay_ms = Delay_ms_64MHz;
...
sys_clk_sel_t Pll_Unlock_Check(void) {
    ...
    /*PLL 48Mhz/64Mhz unlock check*/
    if ((sys_clk_mode == SYS_CLK_48MHZ) || (sys_clk_mode == SYS_CLK_64MHZ)) {

        if (((PLL_VIBIT_STATUS() == PLL_UNLOCK_VIBIT_A) 
             && (PLL_BANK_VCO_STATUS() == PLL_UNLOCK_BANK_VCO_A)) 
            || ((PLL_VIBIT_STATUS() == PLL_UNLOCK_VIBIT_B) 
                 && (PLL_BANK_VCO_STATUS() == PLL_UNLOCK_BANK_VCO_B))) {
        ...
        } else if (((PLL_VIBIT_STATUS() == PLL_UNLOCK_VIBIT_A)) 
                   || ((PLL_VIBIT_STATUS() == PLL_UNLOCK_VIBIT_B))) {
            enter_critical_section();
