...
#define TRUE                                                                   \
    (1UL) ///< Boolean true, define to use in API parameters or return value
#define FALSE                                                                  \
    (0UL) ///< Boolean false, define to use in API parameters or return value
...
#define BYTE0_Msk                                                              \
    (0x000000FFUL) ///< Mask to get bit0~bit7 from a 32 bit integer
#define BYTE1_Msk                                                              \
    (0x0000FF00UL) ///< Mask to get bit8~bit15 from a 32 bit integer
#define BYTE2_Msk                                                              \
    (0x00FF0000UL) ///< Mask to get bit16~bit23 from a 32 bit integer
#define BYTE3_Msk                                                              \
    (0xFF000000UL) ///< Mask to get bit24~bit31 from a 32 bit integer

#define GET_BYTE0(u32Param)                                                    \
    (((u32Param)                                                               \
      & BYTE0_Msk)) /*!< Extract Byte 0 (Bit  0~ 7) from parameter u32Param */
#define GET_BYTE1(u32Param)                                                    \
    (((u32Param) & BYTE1_Msk)                                                  \
     >> 8) /*!< Extract Byte 1 (Bit  8~15) from parameter u32Param */
#define GET_BYTE2(u32Param)                                                    \
    (((u32Param) & BYTE2_Msk)                                                  \
     >> 16) /*!< Extract Byte 2 (Bit 16~23) from parameter u32Param */
#define GET_BYTE3(u32Param)                                                    \
    (((u32Param) & BYTE3_Msk)                                                  \
     >> 24) /*!< Extract Byte 3 (Bit 24~31) from parameter u32Param */
