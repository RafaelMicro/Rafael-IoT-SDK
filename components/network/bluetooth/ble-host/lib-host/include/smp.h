...
#define CODE_SMP_MAX_HANDLE_RANGE                               CODE_SMP_PAIRING_KEYPRESS_NOTIFICATION
...
#define STK_GEN_MTHD_NUMERIC_COMP                               0x03

#define PAIRING_MTHD_LEGACY                                     0x00
#define PAIRING_MTHD_LE_SC                                      0x01
...
typedef struct smp_op_keypress_notification_t
{
    uint8_t   SmprOpcode;
    uint8_t   notification_type;
} smp_op_keypress_notification_t;
...
extern ble_err_t (* const Prcss_BLE_CODE_SMP[])(void);
